...
public class Game extends Thread{
    ...
    private String status = "playing";//游戏状态， palying-->finished
    private String loser = "";//all:平， A:A输， B:B输
...
//            System.out.println("===B===");
    ...
    private void sendBotCode(Player player){
        ...
        data.add("input", getInput(player));//表示当前的局面
    ...
    private boolean nextStep(){
        //等待两名玩家的下一步操作
        //由于前端画200ms才能画一个格子
        //如果在此期间接收到的输入多余一步，只会留最后一步，多余的会被覆盖
        //因此在每一个下一步都要先休息200ms
        try{
            Thread.sleep(200);
